      ...
      <div className="pt-20 pb-16 text-center">
        <div className="container-custom">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            <span className="theme-heading-muted">{language === 'en' ? 'My ' : 'Meus '}</span>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="service-page-card">
              ...
              <h3 className="text-2xl font-bold mb-4 text-center theme-heading-muted">
          ...
          <div className="text-center mt-20">
            <h2 className="text-3xl font-bold mb-6 theme-heading-muted">
